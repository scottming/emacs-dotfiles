...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (highlight-escape-sequences whole-line-or-region move-dup page-break-lines multiple-cursors avy expand-region browse-kill-ring rainbow-delimiters beacon mode-line-bell vlf list-unicode-display unfill exec-path-from-shell fullframe seq highlight-indent-guides symbol-overlay guide-key solarized-theme color-theme-sanityinc-tomorrow smart-tab parinfer evil-multiedit evil-vimish-fold emacs-lisp company popwin swiper counsel smartparens neotree aggressive-indent hungry-delete window-numbering powerline which-key use-package org-bullets monokai-theme zenburn-theme evil-leader evil-surround evil-nerd-commenter evil-paredit evil-smartparens clojure-mode yasnippet)))
